...
<html>
    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    当前页:${pageInfo.pageNum}，总共${pageInfo.pages}页，总共${pageInfo.total}条记录
                </div>
                <div class="col-md-6">
                    <nav aria-label="Page navigation">
                        <ul class="pagination">
                            <li>
                                <a href="${PRO_PATH}/emps?pn=1">首页</a>
                            </li>
                            <c:if test="${pageInfo.hasPreviousPage}">
                                <li>
                                    <a href="${PRO_PATH}/emps?pn=${pageInfo.pageNum-1}" aria-label="Previous">
                            ...
                            <c:forEach items="${pageInfo.navigatepageNums}" var="page_Num">
                                ...
                                <c:if test="${page_Num != pageInfo.pageNum}">
                                    <li><a href="${PRO_PATH}/emps?pn=${page_Num}">${page_Num}</a></li>
                                </c:if>
                            </c:forEach>
                            <c:if test="${pageInfo.hasNextPage}">
                                <li>
                                    <a href="${PRO_PATH}/emps?pn=${pageInfo.pageNum+1}" aria-label="Next">
                                        <span aria-hidden="true">&raquo;</span>
                                    </a>
                                </li>
                            </c:if>
                            <li>
                                <a href="${PRO_PATH}/emps?pn=${pageInfo.pages}">末页</a>
                            </li>
                        </ul>
                    </nav>
                </div>
